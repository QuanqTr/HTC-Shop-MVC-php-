        ...
        <div class="card card-border-color card-border-color-primary">
            ...
            <div class="card-body">
                ...
                <form action="/admin/edit" method="POST">
                    <input value=/uploads/<?= $data->avatar ?> class="form-control form-control-sm" type="hidden"
                        name="avatar">
                    <div class="form-group row">
                        <label class="col-12 col-form-label mb-2">Họ và tên</label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input value="<?= $data->firstname ?>" class="form-control form-control-sm" type="text"
                                name="firstname">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input value="<?= $data->email ?>" class="form-control form-control-sm" type="email"
                                name="email">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input value="<?= $data->diachi ?>" class="form-control form-control-sm" type="text"
                                name="diachi">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input value="<?= $data->phone ?>" class="form-control form-control-sm" type="number"
                                name="phone">
                        </div>
                    </div>
