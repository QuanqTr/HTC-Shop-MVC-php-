...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-table">
            <div class="card-header">Loại sản phẩm
                <div class="tools dropdown">
                    </span><a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"><span
                        ...
                        <tr>
                            ...
                            <td style="width:60px" class="actions">
                                <a class="btn btn-danger btn-sm" data-toggle="modal"
                                    data-target="#mod-danger-<?= $item->id ?>" type="button">Xóa</a>
                            </td>
                            <td style="width:60px" class="actions"><a class="btn btn-primary btn-sm"
                                    href="/admin/categories/edit?id=<?= $item->id ?>">Sửa</a></td>
                        </tr>
                        <?php $i++ ?>
                        <?php endforeach ?>
                    </tbody>
            ...
            <div class="modal-body">
                <div class="text-center">
                    ...
                    <div class="mt-8">
                        ...
                        <a href="/admin/categories/destroy?id=<?= $item->id ?>" class="btn btn-space btn-danger">Đồng
                            ý</a>
                    </div>
                </div>
            </div>
