                ...
                <div class="splash-container">
                    <div class="card card-border-color card-border-color-primary">
                        <div class="card-header">
                            <span style="font-size:22px; color:#4285f4; font-weight: 500 ">HTCShop</span>
                            <span class="splash-description">Vui lòng đăng nhập tài khoản admin.</span>
                        </div>
                        <div class="card-body">
                            <?php Application::$app->showErrorMsgs() ?>
                            <form action="/login?rd=2" method="POST">
                                <div class="form-group">
                                    <input class="form-control" id="username" type="text" placeholder="Login ID"
                                        autocomplete="off" name="login_id">
                                </div>
                                <div class="form-group">
